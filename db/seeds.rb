...
video2 = Video.create!(title: "World's smallest cat", description: Faker::Lorem.paragraph, url: "https://www.youtube.com/embed/W86cTIoMv2U", user_id: user1.id)

video3 = Video.create!(title: "Little cat on a fence in the gaden", description: Faker::Lorem.paragraph, url: "https://assets.mixkit.co/videos/preview/mixkit-little-cat-on-a-fence-in-the-gaden-33152-large.mp4", user_id: user2.id)

video4 = Video.create!(title: "Cute red kitten sleeping in the couch", description: Faker::Lorem.paragraph, url: "https://assets.mixkit.co/videos/preview/mixkit-cute-red-kitten-sleeping-in-the-couch-32319-large.mp4", user_id: user2.id)

video5 = Video.create!(title: "White cat lying among the grasses seen up close", description: Faker::Lorem.paragraph, url: "https://assets.mixkit.co/videos/preview/mixkit-white-cat-lying-among-the-grasses-seen-up-close-22732-large.mp4", user_id: user2.id)

video6 = Video.create!(title: "Newborn fluffy kittens", description: Faker::Lorem.paragraph, url: "https://assets.mixkit.co/videos/preview/mixkit-newborn-fluffy-kittens-31978-large.mp4", user_id: user2.id)

video7 = Video.create!(title: "White, blue-eyed cat", description: Faker::Lorem.paragraph, url: "https://assets.mixkit.co/videos/preview/mixkit-white-blue-eyed-cat-1538-large.mp4", user_id: user3.id)

video8 = Video.create!(title: "Siamese cat inside a hat", description: Faker::Lorem.paragraph, url: "https://assets.mixkit.co/videos/preview/mixkit-siamese-cat-inside-a-hat-4103-large.mp4", user_id: user3.id)

video9 = Video.create!(title: "A couple of cats in the snow", description: Faker::Lorem.paragraph, url: "https://assets.mixkit.co/videos/preview/mixkit-a-couple-of-cats-in-the-snow-9949-large.mp4", user_id: user3.id)
